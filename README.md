...
|---|---|---|---|---|
| holiday-japanese | 6,467,308.15 | 0.0002 | 0.0002 | ±0.06% |
| holiday_jp | 30,417.59 | 0.0332 | 0.0400 | ±0.30% |
| japanese-holidays | 2,790,608.42 | 0.0004 | 0.0005 | ±0.07% |

**between (1 year)**

| name | hz | mean (ms) | p99 (ms) | rme |
|---|---|---|---|---|
| holiday-japanese | 1,001,768.87 | 0.0010 | 0.0012 | ±0.08% |
| holiday_jp | 3,007.80 | 0.3344 | 0.3854 | ±0.58% |
| japanese-holidays | 923,521.45 | 0.0011 | 0.0013 | ±0.09% |

**between (10 years)**

| name | hz | mean (ms) | p99 (ms) | rme |
|---|---|---|---|---|
| holiday-japanese | 63,895.11 | 0.0157 | 0.0173 | ±0.08% |
| holiday_jp | 2,885.77 | 0.3467 | 0.3662 | ±0.06% |
| japanese-holidays | 67,483.72 | 0.0149 | 0.0161 | ±0.08% |
